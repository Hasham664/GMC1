import SidebarPatnerListing from "../../common/agent-view/SidebarPatnerListing";
    ...
    React.useEffect(() => {
        const fetchData = async () => {
          try {
            ...
            await axios.get(`${baseURL}vendors`,{}).then((response) => {
              let resp = response?.data?.agents;   
              setAllList(resp);
              setList(resp);  
              setVendorList(response?.data?.userType);
            });
                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-lg-4 col-xl-4">
                            <SidebarPatnerListing filterDataPartners={filterDataPartners} vendorlist={vendorlist}/>
                        </div>
                        {/* End sidevar .col */}
